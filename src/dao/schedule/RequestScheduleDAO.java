...
public class RequestScheduleDAO {
    ...
    public List<RequestSchedule> getPendingRequestByFaculty(String facultyId, String date) {
        List<RequestSchedule> facultyPendingRequests = new ArrayList<>();
        try {
