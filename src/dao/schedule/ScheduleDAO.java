    ...
    public List<Schedule> getRoom(String roomCode){
        ...
        try {
            ...
            while(set.next()){
                ...
                schedule.load(0,roomCode , set.getString("CourseCode"),set.getString("SectionKey"), roomCode, set.getString("TimeIn"), set.getString("TimeOut"), roomCode, set.getString("Status"), 0);
    ...
    public List<Schedule> addRoomSchedules(String roomCode, List<Schedule> schedules){
        try {
            ...
            while(set.next()){
                ...
                set.getString(4), set.getString(5), set.getString(6), set.getString(7), set.getString(8), set.getInt(9));
                schedules.add(schedule);
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
